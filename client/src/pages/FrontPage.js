...
const FrontPage = () => {
    ...
    return (<>
            ...
            <p className='description'>[<strong>It is essentially Reddit's r/Place</strong>]<br/> But, its for The Game{'\u2122'} Discord! <br/> <br/> If you don't know what r/Place is... <br/> <br/> &nbsp;&nbsp;&nbsp;&nbsp; It is essentially a canvas comprised of a certain amount of pixels, where each player can pick a color and set one pixel to that color! Afterwards, they are placed on a cooldown and cannot change the color of another pixel until the cooldown is over.</p>
